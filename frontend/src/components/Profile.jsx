...
const Profile = () => {
  ...
  return (
    <>
    <section className="bg-white mt-16 m-2 p-2 py-8 antialiased dark:bg-gray-900 md:py-8">
  <div className="mx-auto max-w-screen-lg px-4 2xl:px-0">
    ...
    <div className="py-4 md:py-8">
      <div className="mb-4 grid gap-4 sm:grid-cols-2 sm:gap-8 lg:gap-16">
        <div className="space-y-4">
          <div className="flex space-x-4">
            <img className="h-16 w-16 rounded-lg" src={avatar} alt="user-profile" />
            <div>
              <span className="mb-2 inline-block rounded bg-green-300 px-2.5 py-0.5 text-xs font-medium text-white dark:bg-primary-900 dark:text-primary-300"> {user.role} </span>
            ...
            <dd className="flex items-center space-x-4 text-gray-500 dark:text-gray-400">
              ...
              <div>
                <div className="text-sm">
                  <p className="mb-0.5 font-medium text-gray-500 dark:text-white">Cash On Delivery</p>
      ...
      <button type="button" onClick={handleClick} data-modal-target="accountInformationModal2" data-modal-toggle="accountInformationModal2" class="inline-flex w-full items-center justify-center rounded-lg bg-slate-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-slate-500 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 sm:w-auto">
    ...
    <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800 md:p-8">
      ...
      {orderList.length > 0 ? (
      orderList.map((order)=>(
      <div className="flex flex-wrap items-center gap-y-4 border-b border-gray-200 pb-4 dark:border-gray-700 md:pb-5 m-2">
        <dl className="w-60 sm:w-64">
        ...
        <dl className="w-60 sm:w-64 md:flex-1 lg:w-auto">
        ...
        <form className="p-4 md:p-5">
          <div className="mb-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="col-span-2">
              <label for="pick-up-point-input" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Pick-up point* </label>
            ...
            <div className="col-span-2 sm:col-span-1">
              <label for="full_name_info_modal" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Your Full Name* </label>
            ...
            <div className="col-span-2 sm:col-span-1">
              <label for="email_info_modal" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Your Email* </label>
            ...
            <div className="col-span-2">
              <label for="address_billing_modal" className="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Delivery Address* </label>
